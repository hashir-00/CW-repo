...
public class Main {
   ...
   static char[] row3 = new char[20];
    static int ticket_number=0;//to keep count of number of tickets
        ...
        while (input != '0') {
            ...
            if (input == 1) {
                ...
                while (x != 0) {
                    ...
                    if (srow == 1) {
                        ticket_number++;
                        buy_ticket(row1,10,1,ticket_list,ticket_number);


                    } else if (srow == 2) {
                        ticket_number++;
                        buy_ticket(row2,20,2,ticket_list,ticket_number);
                    } else if (srow == 3) {
                        ticket_number++;
                        buy_ticket(row3,30,3,ticket_list,ticket_number);
                    } else {
                ...
                while (e != 0) {
                    ...
                    if (srow == 1) {
                        ...
                        cancel_s(row1,ticket_list,ticket_number);
                        ticket_number--;

                    } else if (srow == 2) {
                        cancel_s(row2,ticket_list,ticket_number);
                        ticket_number--;
                    } else if (srow == 3) {
                        cancel_s(row3,ticket_list,ticket_number);
                        ticket_number--;
                    } else//rows in range
                    {
                        System.out.println("invalid input.available rows -1,2,3\n");
                ...
                available_s(row1, row2, row3);
            } else if (input == 5) {
                save_f(row1, row2, row3);

            } else if (input == 6) {
                load_f(row1,row2,row3);
...
/*
    ...
    public static void buy_ticket(char[] row,int price,int row_number,ArrayList<Ticket> ticket_list,int ticket_number) {
        ...
        Ticket ticket=new Ticket(ticket_number,row_number,snum,price,person1);
    ...
    public static void seatings_p(char[] row1, char[] row2, char[] row3) {
    ...
    public static void cancel_s(char[] row, ArrayList<Ticket> ticket_list,int ticket_number) {
        ...
        if (row[snum - 1] != 'X') {
            ...
            for(int i=0;i<ticket_list.size();i++){
                ...
                System.out.println(ticket_list.indexOf(ticket));
                ticket.print();
            }
            System.out.println("select the ticket you want to remove");
                ticket_number=scan.nextInt();


            System.out.println("this ticket has been removed");
            ticket_list.get(ticket_number-1).print();
    ...
    public static void available_s(char[] row1, char[] row2, char[] row3) {
        avail_seat(row1, '1');
    ...
    public static void save_f(char[] a, char[] b, char[] c) {
    ...
    public static void load_f( char [] row1,char [] row2, char [] row3) {
    ...
    public static void print_ticket_info(ArrayList<Ticket> ticket_list){
